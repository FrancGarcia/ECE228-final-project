# BEV Trajectory Modelling (Tracking and Prediction)
...
| `bev_trajectory_prediction_updated.ipynb` | Updated version of the pipeline |
...
- Crossing intent: PIE-inspired, colour-coded BEV overlay estimating whether pedestrians and cyclists are likely to cross.
